...
@demo examples/non-version-specific/customize_style.html Customize style and change fonts [V4]
@demo examples/non-version-specific/interact.html Interact [V4]
@demo examples/v4/custom_resources.html Use a custom resource [V4]
...
*/
class MyScriptTextWeb extends Element {
  static get template() {
    return `
